...
import { PRODUCT_BACKGROUND } from '../data/productBackground';
...
## 📚 产品背景资料（重要参考）
在进行剪刀差分析时，请结合以下产品1产品的背景资料，这些资料可以帮助你更好地理解市场环境、竞争结构、生意逻辑和渠道动作：
...
## 📚 产品背景资料（重要参考）
在进行问题分析时，请结合以下产品1产品的背景资料，这些资料可以帮助你更好地理解市场环境、竞争结构、生意逻辑和渠道动作：
...
请以JSON格式输出：
{
  "causes": [
    {
      "problem": "问题描述",
      "statement": "总结性的分析陈述，必须包含环境因素、商业推广因素、产品因素、资源分配因素四个维度的分析。必须使用结构化格式：用两个换行符\\n\\n分隔段落（注意：必须使用两个换行符\\n\\n，不是单个\\n），每个维度独立成段，使用**环境因素**、**商业推广因素**、**产品因素**、**资源分配因素**作为小标题。⚠️ 重要：不要在statement中提及金额和份额数据。例如：'医院内，产品1分子式内表现与竞品A持平，零售渠道内，产品1表现低于竞品A。\\n\\n**环境因素**：产品1主要是低剂量中标省份（如安徽、合肥）的表现明显低，这些省份集采政策严格，仅低剂量中标导致院内处方向零售转移受限。\\n\\n**产品因素**：产品1在低剂量剂量数据量是高剂量的近2倍，说明低剂量是主要使用剂量，但产品1在低剂量剂量的产品定位和患者教育可能不足，导致患者对低剂量产品的认知和接受度有限。\\n\\n**商业推广因素**：产品1低剂量的WD为25.92，而竞品A低剂量的WD为46.85，两者相差20.93个百分点，说明在低剂量剂量的商业推广和渠道覆盖上，产品1明显弱于竞品A，渠道铺货不足限制了产品的可及性。\\n\\n**资源分配因素**：产品1可能将更多资源投入到高剂量产品的学术推广和医生教育上，而低剂量产品的市场教育和患者管理投入相对不足，相比之下，竞品A在低剂量剂量上的市场投入更充分，包括患者教育、渠道建设和医生沟通，这解释了为什么竞品A表现更好。'"
    }
  ]
}
...
\`\`\`json
{
  "causes": [
    {
      "problem": "剪刀差标题",
      "statement": "总结性的分析陈述，必须包含环境因素、商业推广因素、产品因素、资源分配因素四个维度的分析。必须使用结构化格式：用两个换行符\\n\\n分隔段落（注意：必须使用两个换行符\\n\\n，不是单个\\n），每个维度独立成段，使用**环境因素**、**商业推广因素**、**产品因素**、**资源分配因素**作为小标题。WD（分销率）数据只在商业推广因素中提及，其他维度要用domain knowledge来丰富分析。⚠️ 重要：不要在statement中提及金额和份额数据。例如：'医院内，产品1分子式内表现与竞品A持平，零售渠道内，产品1表现低于竞品A。\\n\\n**环境因素**：产品1主要是低剂量中标省份（如安徽、合肥）的表现明显低，这些省份集采政策严格，仅低剂量中标导致院内处方向零售转移受限，同时这些省份的零售市场准入门槛较高，对原研产品的接受度相对较低。\\n\\n**产品因素**：产品1在低剂量剂量数据量是高剂量的近2倍，说明低剂量是主要使用剂量，但产品1在低剂量剂量的产品定位和患者教育可能不足，导致患者对低剂量产品的认知和接受度有限，而高剂量产品虽然使用频率低但单次价值高，更容易获得市场关注。\\n\\n**商业推广因素**：产品1低剂量的WD为25.92，而竞品A低剂量的WD为46.85，两者相差20.93个百分点，说明在低剂量剂量的商业推广和渠道覆盖上，产品1明显弱于竞品A，渠道铺货不足限制了产品的可及性。\\n\\n**资源分配因素**：产品1可能将更多资源投入到高剂量产品的学术推广和医生教育上，而低剂量产品的市场教育和患者管理投入相对不足，相比之下，竞品A在低剂量剂量上的市场投入更充分，包括患者教育、渠道建设和医生沟通，这解释了为什么竞品A表现更好。'"
    }
  ]
}
\`\`\`
...
"医院内，产品1分子式内表现与竞品A持平，零售渠道内，产品1表现低于竞品A。\\n\\n**环境因素**：产品1主要是低剂量中标省份（如安徽、合肥）的表现明显低，这些省份集采政策严格，仅低剂量中标导致院内处方向零售转移受限，同时这些省份的零售市场准入门槛较高，对原研产品的接受度相对较低。\\n\\n**产品因素**：产品1在低剂量剂量数据量是高剂量的近2倍，说明低剂量是主要使用剂量，但产品1在低剂量剂量的产品定位和患者教育可能不足，导致患者对低剂量产品的认知和接受度有限，而高剂量产品虽然使用频率低但单次价值高，更容易获得市场关注。\\n\\n**商业推广因素**：产品1低剂量的WD为25.92，而竞品A低剂量的WD为46.85，两者相差20.93个百分点，说明在低剂量剂量的商业推广和渠道覆盖上，产品1明显弱于竞品A，渠道铺货不足限制了产品的可及性。\\n\\n**资源分配因素**：产品1可能将更多资源投入到高剂量产品的学术推广和医生教育上，而低剂量产品的市场教育和患者管理投入相对不足，相比之下，竞品A在低剂量剂量上的市场投入更充分，包括患者教育、渠道建设和医生沟通，这解释了为什么竞品A表现更好。"
...
\`\`\`json
{
  "causes": [
    {
      "problem": "${gap.title}",
      "statement": "总结性的分析陈述，必须包含环境因素、商业推广因素、产品因素、资源分配因素四个维度的分析。必须使用结构化格式：用两个换行符\\n\\n分隔段落（注意：必须使用两个换行符\\n\\n，不是单个\\n），每个维度独立成段，使用**环境因素**、**商业推广因素**、**产品因素**、**资源分配因素**作为小标题。必须引用具体数据，但⚠️ 重要：不要在statement中提及金额和份额数据。例如：'医院内，产品1分子式内表现与竞品A持平，零售渠道内，产品1表现低于竞品A。\\n\\n**环境因素**：产品1主要是低剂量中标省份（如安徽、合肥）的表现明显低，这些省份集采政策严格，仅低剂量中标导致院内处方向零售转移受限。\\n\\n**产品因素**：产品1在低剂量剂量数据量是高剂量的近2倍，说明低剂量是主要使用剂量，但产品1在低剂量剂量的产品定位和患者教育可能不足，导致患者对低剂量产品的认知和接受度有限。\\n\\n**商业推广因素**：产品1低剂量的WD为25.92，而竞品A低剂量的WD为46.85，两者相差20.93个百分点，说明在低剂量剂量的商业推广和渠道覆盖上，产品1明显弱于竞品A，渠道铺货不足限制了产品的可及性。\\n\\n**资源分配因素**：产品1可能将更多资源投入到高剂量产品的学术推广和医生教育上，而低剂量产品的市场教育和患者管理投入相对不足，相比之下，竞品A在低剂量剂量上的市场投入更充分，包括患者教育、渠道建设和医生沟通，这解释了为什么竞品A表现更好。'"
    }
  ]
}
\`\`\`
