...
面向CEO和决策层的智能策略规划工具，内置某医药公司"三层"运营体系与产品矩阵知识库。

## 核心特性

- **全局 AI 业务大脑**: 内置某医药公司"三层"运营体系与产品矩阵知识库，所有 AI 建议均基于"以患者需求为导向"和"准入-渗透-扩面"的业务逻辑生成。
...
#### 功能一：全国层面各产品表现整体解读
- **分产品诊断报告**
  - **就数论数**：提取内外部数据中某医药公司产品表现，定位变化幅度较大的产品及指标，提供风险预警
  - **数据解读**：实时联网，链接与某医药公司产品相关的可靠信息源，从"蛛丝马迹"中获取对某医药公司产品表现的可能原因，并智能建议进一步可以锁定问题的解决方案

#### 功能二：省份间表现智能横向对比
- **各省表现诊断报告**
  - 基于核心维度（市场份额、ROI、非核心产品占比等）及核心指标表现（准入率、渗透率等），AI智能定位各省份中表现优异、表现不理想的省份，得出"健康度评分"
...
- **Mekko数据看板**：依照维度生成数据看板，AI帮助定位值得某医药公司明显未布局/份额明显低、具备提升潜力的细分市场
